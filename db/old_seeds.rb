...
"/volvo/xc90/2016"
  ...
  year_links.each do |year_link|
      ...
      if(doc) 
        ...
        transmission_type = "#{transmission_speed} #{transmission}"

        link_split = year_link.split("/")
        make = link_split[1].gsub("-", " ").titleize
        model = link_split[2].gsub("-", " ").titleize
        year = link_split[3]
